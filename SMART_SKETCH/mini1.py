...
class HouseDesignerApp:
    ...
    # Frame for navigation buttons
     ...
     self.previous_button = tk.Button(button_frame, text="Previous Design", font=("Arial", 16), command=self.previous_design, state=tk.DISABLED)
     self.previous_button.pack(side=tk.LEFT, padx=10)

     self.next_button = tk.Button(button_frame, text="Next Design", font=("Arial", 16), command=self.next_design, state=tk.DISABLED)
     self.next_button.pack(side=tk.LEFT, padx=10)

     self.back_button = tk.Button(button_frame, text="Back", font=("Arial", 16), command=self.show_design_choice_page)
     self.back_button.pack(side=tk.RIGHT, padx=10)

     self.confirm_button = tk.Button(self.main_frame, text="Confirm Design", font=("Arial", 16), command=self.confirm_design, state=tk.DISABLED)
